...
conversation; the model decides which of the server's 27 tools to call; the
...
```
   ...
   ==================== process boundary (stdio) ======================
                |                                              |
        +--------------------------------------------------------------+
        | ../server.py      UNCHANGED. Diamond safety layer, 27 tools   |
        +--------------------------------------------------------------+
                                      |
                                 UR10e / simulator
```
...
| `--vision` | on | Merged camera+robot server (35 tools); `--no-vision` gives 27 and no camera |
